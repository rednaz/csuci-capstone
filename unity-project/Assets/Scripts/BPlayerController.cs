...
public class BPlayerController : PlayerController 
{
	...
	void Start () 
	{
		...
		attackValues[ 0, 0 ] = 8; 		attackValues[ 0, 1 ] = 10;		attackValues[ 0, 2 ] = 6;		attackValues[ 0, 3 ] = 12;   //totalFrames
		attackValues[ 1, 0 ] = 6; 		attackValues[ 1, 1 ] = 6;		attackValues[ 1, 2 ] = 6;		attackValues[ 1, 3 ] = 6;	//startFrame
		attackValues[ 2, 0 ] = 4; 		attackValues[ 2, 1 ] = 6;		attackValues[ 2, 2 ] = 6;		attackValues[ 2, 3 ] = 6;	//finishFrame
		...
		attackValues[ 5, 0 ] = 10; 		attackValues[ 5, 1 ] = 20;		attackValues[ 5, 2 ] = 10;		attackValues[ 5, 3 ] = 20;	//damage
		attackValues[ 6, 0 ] = 6; 		attackValues[ 6, 1 ] = 6;		attackValues[ 6, 2 ] = 6;		attackValues[ 6, 3 ] = 6;	//damageType
